        ...
        <nav className='nav'>
            <div className='container'>
                ...
                <div className='nav__search'>
                        <input onChange={event => { setSearchInputValue(event.target.value)}} value={searchInputValue} 
                               onKeyDown={event => { if (event.key === 'Enter') {searchHandle(searchInputValue)}}}
                               type='text' name='search' placeholder='Search hero'></input>
